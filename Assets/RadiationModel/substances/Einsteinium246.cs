...
namespace RadiationModel.substances
{
    public class Einsteinium246 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9009999999999999d, new List<RadioactiveSubstance> { new BetaParticle(), new Californium246() } },

            { 0.099d, new List<RadioactiveSubstance> { new AlphaParticle(), new Berkelium242() } },
