...
namespace RadiationModel.substances
{
    public class Francium221 : RadioactiveSubstance
    {
        ...
        {
            { 1.0d, new List<RadioactiveSubstance> { new AlphaParticle(7479002.09), new Astatine217() } },
            { 4.7999999999999994e-05d, new List<RadioactiveSubstance> { new BetaParticle(-1, 313000.0), new Radium221() } },
