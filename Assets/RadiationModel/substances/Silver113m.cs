...
namespace RadiationModel.substances
{
    public class Silver113m : RadioactiveSubstance
    {
        ...
        {
            { 0.64d, new List<RadioactiveSubstance> { new GammaParticle(0.02883, 43000.0), new Silver113() } },
            { 0.36d, new List<RadioactiveSubstance> { new BetaParticle(-1, 2059290.0), new Cadmium113() } },
