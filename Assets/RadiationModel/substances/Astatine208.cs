...
namespace RadiationModel.substances
{
    public class Astatine208 : RadioactiveSubstance
    {
        ...
        {
            { 0.9945d, new List<RadioactiveSubstance> { new BetaParticle(1, 4999200.0), new Polonium208() } },
            { 0.0055000000000000005d, new List<RadioactiveSubstance> { new AlphaParticle(6773002.09), new Bismuth204() } },
