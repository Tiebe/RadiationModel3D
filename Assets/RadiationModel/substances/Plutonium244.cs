...
namespace RadiationModel.substances
{
    public class Plutonium244 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9987699999999999d, new List<RadioactiveSubstance> { new AlphaParticle(), new Uranium240() } },

            { 0.00123d, new List<RadioactiveSubstance> {  } },

            { 7.3e-11d, new List<RadioactiveSubstance> { new BetaParticle(), new Curium244() } },
