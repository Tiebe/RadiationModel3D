...
namespace RadiationModel.substances
{
    public class Technetium89m : RadioactiveSubstance
    {
        ...
        {
            { 1.0d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Niobium89() }, { 1.0d, new BetaParticle(1, betaPlusSpectrum) } } },
            { 0.0001d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Technetium89() } } },
