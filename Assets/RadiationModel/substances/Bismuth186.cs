...
namespace RadiationModel.substances
{
    public class Bismuth186 : RadioactiveSubstance
    {
        ...
        {
            { 0.955d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Thallium182() }, { 1.0d, new AlphaParticle(8779002.09) } } },
            { 0.045d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Thallium186() }, { 1.0d, new BetaParticle(1, betaPlusSpectrum) } } },
