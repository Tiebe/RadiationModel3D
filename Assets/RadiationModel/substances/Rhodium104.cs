...
namespace RadiationModel.substances
{
    public class Rhodium104 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9954999999999999d, new List<RadioactiveSubstance> { new BetaParticle(), new Palladium104() } },

            { 0.0045000000000000005d, new List<RadioactiveSubstance> { new BetaParticle(), new Ruthenium104() } },
