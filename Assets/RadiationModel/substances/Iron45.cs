...
namespace RadiationModel.substances
{
    public class Iron45 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, Dictionary<double, RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.43d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Chromium45() }, { 1.0d, new BetaParticle(1, betaPlusSpectrum) } } },
            { 0.43d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Chromium44() }, { 1.0d, new BetaParticle(1, betaPlusSpectrum) }, { 1.0d, new ProtonParticle() } } },
