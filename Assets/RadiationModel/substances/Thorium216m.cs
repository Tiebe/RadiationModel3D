...
namespace RadiationModel.substances
{
    public class Thorium216m : RadioactiveSubstance
    {
        ...
        {
            { 0.972d, new List<RadioactiveSubstance> { new GammaParticle(0.00061, 2041000.0), new Thorium216() } },
            { 0.027999999999999997d, new List<RadioactiveSubstance> { new AlphaParticle(11134047.4), new Radium212() } },
