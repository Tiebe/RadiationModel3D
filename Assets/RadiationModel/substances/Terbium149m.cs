...
namespace RadiationModel.substances
{
    public class Terbium149m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 1.0d, new List<RadioactiveSubstance> { new BetaParticle(), new Gadolinium149() } },

            { 0.00021999999999999998d, new List<RadioactiveSubstance> { new AlphaParticle(), new Europium145() } },
