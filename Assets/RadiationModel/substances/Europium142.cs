...
namespace RadiationModel.substances
{
    public class Europium142 : RadioactiveSubstance
    {
        ...
        {
            { 1.0d, new List<RadioactiveSubstance> { new BetaParticle(1, 7671900.0), new Samarium142() } },
            { 0.899d, new List<RadioactiveSubstance> { new BetaParticle(1, 7671900.0), new Samarium142() } },
