...
namespace RadiationModel.substances
{
    public class Astatine193n : RadioactiveSubstance
    {
        ...
        {
            { 0.76d, new List<RadioactiveSubstance> { new GammaParticle((42000.0, 0.02952)), new Astatine193() } },
            { 0.24d, new List<RadioactiveSubstance> { new AlphaParticle(8637002.09), new Bismuth189() } },
