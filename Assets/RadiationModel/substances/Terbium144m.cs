...
namespace RadiationModel.substances
{
    public class Terbium144m : RadioactiveSubstance
    {
        ...
        {
            { 0.66d, new List<RadioactiveSubstance> { new GammaParticle((397000.0, 0.00312)), new Terbium144() } },
            { 0.34d, new List<RadioactiveSubstance> { new BetaParticle(1, 9789000.0), new Gadolinium144() } },
