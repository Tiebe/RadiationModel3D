...
namespace RadiationModel.substances
{
    public class Iridium190p : RadioactiveSubstance
    {
        ...
        {
            { 0.914d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Rhenium190() }, { 1.0d, new BetaParticle(1, -397099.99999) }, { 0.00074d, new GammaParticle(38900.0, 0.03187) }, { 0.6416d, new GammaParticle(186700.0, 0.00664) }, { 0.8674d, new GammaParticle(361200.0, 0.00343) }, { 0.8937999999999999d, new GammaParticle(502500.0, 0.00247) }, { 0.9012d, new GammaParticle(616500.0, 0.00201) }, { 0.519712461521176d, new GammaParticle(10393.0, 0.1193) }, { 0.2516525049670191d, new GammaParticle(61486.0, 0.02016) }, { 0.4336593227072533d, new GammaParticle(63000.0, 0.01968) }, { 0.14509336351541235d, new GammaParticle(71496.0, 0.01734) }, { 0.1857195052997278d, new GammaParticle(72338.0, 0.01714) }, { 0.04062614178431546d, new GammaParticle(73364.0, 0.0169) } } },
