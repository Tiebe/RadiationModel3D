...
namespace RadiationModel.substances
{
    public class Silver105m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9965999999999999d, new List<RadioactiveSubstance> { new GammaParticle(), new Silver105() } },

            { 0.0034000000000000002d, new List<RadioactiveSubstance> { new BetaParticle(), new Palladium105() } },
