...
namespace RadiationModel.substances
{
    public class Tin121m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.7759999999999999d, new List<RadioactiveSubstance> { new GammaParticle(), new Tin121() } },

            { 0.22399999999999998d, new List<RadioactiveSubstance> { new BetaParticle(), new Antimony121() } },
