...
namespace RadiationModel.substances
{
    public class Americium237 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9997499999999999d, new List<RadioactiveSubstance> { new BetaParticle(), new Plutonium237() } },

            { 0.00025d, new List<RadioactiveSubstance> { new AlphaParticle(), new Neptunium233() } },
