...
namespace RadiationModel.substances
{
    public class Promethium142 : RadioactiveSubstance
    {
        ...
        {
            { 1.0d, new List<RadioactiveSubstance> { new BetaParticle(1, 4808100.0), new Neodymium142() } },
            { 0.7709999999999999d, new List<RadioactiveSubstance> { new BetaParticle(1, 4808100.0), new Neodymium142() } },
