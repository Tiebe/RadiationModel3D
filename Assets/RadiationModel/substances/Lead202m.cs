...
namespace RadiationModel.substances
{
    public class Lead202m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, Dictionary<double, RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.09699999999999999d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Mercury202() }, { 1.0d, new BetaParticle(1, 1787150.00001) }, { 0.0023d, new GammaParticle(148550.0, 0.00835) }, { 0.0077d, new GammaParticle(211920.0, 0.00585) }, { 0.0087d, new GammaParticle(241100.0, 0.00514) }, { 0.0023d, new GammaParticle(335550.0, 0.00369) }, { 0.063d, new GammaParticle(389940.0, 0.00318) }, { 0.08900000000000001d, new GammaParticle(459720.0, 0.0027) }, { 0.094d, new GammaParticle(490470.0, 0.00253) }, { 0.0060999999999999995d, new GammaParticle(601950.0, 0.00206) }, { 0.04147446413061599d, new GammaParticle(12148.0, 0.10206) }, { 0.030292854739291594d, new GammaParticle(70832.0, 0.0175) }, { 0.05113581151129573d, new GammaParticle(72874.0, 0.01701) }, { 0.01739070204426576d, new GammaParticle(82629.0, 0.015) }, { 0.022555740551412688d, new GammaParticle(83631.0, 0.01483) }, { 0.00516503850714693d, new GammaParticle(84866.0, 0.01461) } } },
