...
namespace RadiationModel.substances
{
    public class Antimony128m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9640000000000001d, new List<RadioactiveSubstance> { new BetaParticle(), new Tellurium128() } },

            { 0.036000000000000004d, new List<RadioactiveSubstance> { new GammaParticle(), new Antimony128() } },
