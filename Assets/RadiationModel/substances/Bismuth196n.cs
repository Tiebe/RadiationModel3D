...
namespace RadiationModel.substances
{
    public class Bismuth196n : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.258d, new List<RadioactiveSubstance> { new GammaParticle(0.00456, 272000.0), new Bismuth196() } },
            { 3.8e-06d, new List<RadioactiveSubstance> { new AlphaParticle(6728047.4), new Thallium192() } },
