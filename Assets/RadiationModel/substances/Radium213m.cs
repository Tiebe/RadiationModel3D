...
namespace RadiationModel.substances
{
    public class Radium213m : RadioactiveSubstance
    {
        ...
        {
            { 0.99d, new List<RadioactiveSubstance> { new GammaParticle((1768000.0, 0.0007)), new Radium213() } },
            { 0.006d, new List<RadioactiveSubstance> { new AlphaParticle(9652002.09), new Radon209() } },
