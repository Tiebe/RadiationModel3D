...
namespace RadiationModel.substances
{
    public class Californium242 : RadioactiveSubstance
    {
        ...
        {
            { 0.61d, new List<RadioactiveSubstance> { new AlphaParticle(8539002.09), new Curium238() } },
            { 0.39d, new List<RadioactiveSubstance> { new BetaParticle(1, 1637000.0), new Berkelium242() } },
