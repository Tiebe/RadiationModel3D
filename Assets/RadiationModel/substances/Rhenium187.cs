...
namespace RadiationModel.substances
{
    public class Rhenium187 : RadioactiveSubstance
    {
        ...
        {
            { 1.0d, new List<RadioactiveSubstance> { new BetaParticle(-1, 2500.0), new Osmium187() } },
            { 0.0d, new List<RadioactiveSubstance> { new AlphaParticle(2674002.09), new Tantalum183() } },
