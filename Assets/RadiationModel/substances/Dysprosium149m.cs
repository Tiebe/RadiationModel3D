...
namespace RadiationModel.substances
{
    public class Dysprosium149m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.993d, new List<RadioactiveSubstance> { new GammaParticle(), new Dysprosium149() } },

            { 0.006999999999999999d, new List<RadioactiveSubstance> { new BetaParticle(), new Terbium149() } },
