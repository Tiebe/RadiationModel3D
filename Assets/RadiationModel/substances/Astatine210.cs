...
namespace RadiationModel.substances
{
    public class Astatine210 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9982500000000001d, new List<RadioactiveSubstance> { new BetaParticle(), new Polonium210() } },

            { 0.0017499999999999998d, new List<RadioactiveSubstance> { new AlphaParticle(), new Bismuth206() } },
