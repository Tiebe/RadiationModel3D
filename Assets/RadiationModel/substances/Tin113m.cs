...
namespace RadiationModel.substances
{
    public class Tin113m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9109999999999999d, new List<RadioactiveSubstance> { new GammaParticle(), new Tin113() } },

            { 0.08900000000000001d, new List<RadioactiveSubstance> { new BetaParticle(), new Indium113() } },
