...
namespace RadiationModel.substances
{
    public class Tin113m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, Dictionary<double, RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.08900000000000001d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Cadmium113() }, { 1.0d, new BetaParticle(1, betaPlusSpectrum) }, { 0.0056828547648000004d, new GammaParticle(3571.0, 0.3472) }, { 0.018765911513463532d, new GammaParticle(24001.0, 0.05166) }, { 0.035208089143458784d, new GammaParticle(24209.0, 0.05121) }, { 0.009878602809308974d, new GammaParticle(27367.0, 0.0453) }, { 0.01175553734307768d, new GammaParticle(27581.0, 0.04495) }, { 0.0018769345337687053d, new GammaParticle(27858.0, 0.04451) } } },
