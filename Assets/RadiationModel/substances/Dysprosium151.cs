...
namespace RadiationModel.substances
{
    public class Dysprosium151 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9440000000000001d, new List<RadioactiveSubstance> { new BetaParticle(), new Terbium151() } },

            { 0.055999999999999994d, new List<RadioactiveSubstance> { new AlphaParticle(), new Gadolinium147() } },
