...
namespace RadiationModel.substances
{
    public class Silver102m : RadioactiveSubstance
    {
        ...
        {
            { 0.51d, new List<RadioactiveSubstance> { new BetaParticle(1, 5665000.0), new Palladium102() } },
            { 0.49d, new List<RadioactiveSubstance> { new GammaParticle((9000.0, 0.13776)), new Silver102() } },
