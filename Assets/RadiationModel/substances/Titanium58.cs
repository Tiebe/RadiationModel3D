...
namespace RadiationModel.substances
{
    public class Titanium58 : RadioactiveSubstance
    {
        ...
        {
            { 1.0d, new List<KeyValuePair<double, RadioactiveSubstance>> { new(1.0d, new Vanadium58()), new(1.0d, new BetaParticle(-1, betaMinusSpectrum)), new(0.8d, new GammaParticle(114000.0, 0.01088)) } },
