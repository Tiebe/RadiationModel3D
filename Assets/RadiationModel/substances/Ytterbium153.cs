...
namespace RadiationModel.substances
{
    public class Ytterbium153 : RadioactiveSubstance
    {
        ...
        {
            { 0.9d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Erbium153() }, { 1.0d, new BetaParticle(1, betaPlusSpectrum) } } },
            { 0.1d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Erbium149() }, { 1.0d, new AlphaParticle(5179002.09) } } },
            { 8e-05d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Erbium152() }, { 1.0d, new BetaParticle(1, betaPlusSpectrum) }, { 1.0d, new ProtonParticle() } } },
