...
namespace RadiationModel.substances
{
    public class Neodymium150 : RadioactiveSubstance
    {
        ...
        {
            { 1.0d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Samarium150() }, { 1.0d, new BetaParticle(-1, betaMinusSpectrum) }, { 1.0d, new BetaParticle(-1, betaMinusSpectrum) } } },
