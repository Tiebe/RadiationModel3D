...
namespace RadiationModel.substances
{
    public class Platinum182 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.00962d, new List<RadioactiveSubstance> { new BetaParticle(), new Iridium182() } },

            { 0.00037999999999999997d, new List<RadioactiveSubstance> { new AlphaParticle(), new Osmium178() } },
