...
namespace RadiationModel.substances
{
    public class Seaborgium261 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.981d, new List<RadioactiveSubstance> { new AlphaParticle(), new Rutherfordium257() } },

            { 0.013000000000000001d, new List<RadioactiveSubstance> { new BetaParticle(), new Dubnium261() } },
