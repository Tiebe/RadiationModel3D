...
namespace RadiationModel.substances
{
    public class Mendelevium255p : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<KeyValuePair<double, RadioactiveSubstance>>> decayProducts { get; } = new()
        {
            ...
            { 0.07d, new List<KeyValuePair<double, RadioactiveSubstance>> { new(1.0d, new Einsteinium251()), new(1.0d, new AlphaParticle(8935002.09)), new(0.053d, new GammaParticle(405350.0, 0.00306)), new(0.07d, new GammaParticle(452900.0, 0.00274)) } },
