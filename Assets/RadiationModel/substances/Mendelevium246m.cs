...
namespace RadiationModel.substances
{
    public class Mendelevium246m : RadioactiveSubstance
    {
        ...
        {
            { 0.57d, new List<RadioactiveSubstance> { new AlphaParticle(9967002.09), new Einsteinium242() } },
            { 0.77d, new List<RadioactiveSubstance> { new BetaParticle(1, 5979000.0), new Fermium246() } },
            { 0.23d, new List<RadioactiveSubstance> { new AlphaParticle(9967002.09), new Einsteinium242() } },
