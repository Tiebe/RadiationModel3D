...
namespace RadiationModel.substances
{
    public class Lawrencium254 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.7170000000000001d, new List<RadioactiveSubstance> { new AlphaParticle(), new Mendelevium250() } },

            { 0.28300000000000003d, new List<RadioactiveSubstance> { new BetaParticle(), new Nobelium254() } },
