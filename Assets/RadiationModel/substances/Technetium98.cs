...
namespace RadiationModel.substances
{
    public class Technetium98 : RadioactiveSubstance
    {
        ...
        {
            { 1.0d, new List<RadioactiveSubstance> { new BetaParticle(-1, 1793000.0), new Ruthenium98() } },
            { 0.0d, new List<RadioactiveSubstance> { new BetaParticle(1, 1683980.0), new Molybdenum98() } },
