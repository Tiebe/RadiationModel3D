...
namespace RadiationModel.substances
{
    public class Neptunium236m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, Dictionary<double, RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.49d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Plutonium236() }, { 1.0d, new BetaParticle(-1, betaMinusSpectrum) }, { 0.0016d, new GammaParticle(44630.0, 0.02778) }, { 0.44847679999999995d, new GammaParticle(17604.0, 0.07043) } } },
