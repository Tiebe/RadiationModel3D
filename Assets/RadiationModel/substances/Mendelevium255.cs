...
namespace RadiationModel.substances
{
    public class Mendelevium255 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, Dictionary<double, RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.07d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Einsteinium251() }, { 1.0d, new AlphaParticle(8927002.09) }, { 0.053d, new GammaParticle(405350.0, 0.00306) }, { 0.07d, new GammaParticle(452900.0, 0.00274) } } },
