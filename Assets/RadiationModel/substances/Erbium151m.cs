...
namespace RadiationModel.substances
{
    public class Erbium151m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, Dictionary<double, RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.047d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Dysprosium151() }, { 1.0d, new BetaParticle(1, betaPlusSpectrum) }, { 0.0039000000000000003d, new GammaParticle(128800.0, 0.00963) }, { 0.037000000000000005d, new GammaParticle(296900.0, 0.00418) }, { 0.0062d, new GammaParticle(307200.0, 0.00404) }, { 0.0068000000000000005d, new GammaParticle(403600.0, 0.00307) }, { 0.027000000000000003d, new GammaParticle(414000.0, 0.00299) }, { 0.044000000000000004d, new GammaParticle(597400.0, 0.00208) }, { 0.051d, new GammaParticle(789300.0, 0.00157) }, { 0.0007599999999999999d, new GammaParticle(511000.0, 0.00243) }, { 0.0015d, new GammaParticle(7656.0, 0.16194) }, { 0.0017000000000000001d, new GammaParticle(46700.0, 0.02655) }, { 0.0031d, new GammaParticle(47547.0, 0.02608) }, { 0.00099d, new GammaParticle(53982.0, 0.02297) }, { 0.0012d, new GammaParticle(54577.0, 0.02272) }, { 0.00026d, new GammaParticle(55293.0, 0.02242) } } },
