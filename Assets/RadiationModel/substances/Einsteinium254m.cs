...
namespace RadiationModel.substances
{
    public class Einsteinium254m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.03d, new List<RadioactiveSubstance> { new GammaParticle(0.01544, 80300.0), new Einsteinium254() } },
            { 0.0032d, new List<RadioactiveSubstance> { new AlphaParticle(7717547.4), new Berkelium250() } },
