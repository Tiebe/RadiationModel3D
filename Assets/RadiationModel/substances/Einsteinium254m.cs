...
namespace RadiationModel.substances
{
    public class Einsteinium254m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.98d, new List<RadioactiveSubstance> { new BetaParticle(), new Fermium254() } },

            { 0.03d, new List<RadioactiveSubstance> { new GammaParticle(), new Einsteinium254() } },

            { 0.0032d, new List<RadioactiveSubstance> { new AlphaParticle(), new Berkelium250() } },
