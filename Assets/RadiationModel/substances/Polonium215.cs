...
namespace RadiationModel.substances
{
    public class Polonium215 : RadioactiveSubstance
    {
        ...
        {
            { 1.0d, new List<RadioactiveSubstance> { new AlphaParticle(8548202.09), new Lead211() } },
            { 2.3e-06d, new List<RadioactiveSubstance> { new BetaParticle(-1, 715200.0), new Astatine215() } },
