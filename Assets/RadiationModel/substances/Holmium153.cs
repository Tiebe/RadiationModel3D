...
namespace RadiationModel.substances
{
    public class Holmium153 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.99949d, new List<RadioactiveSubstance> { new BetaParticle(), new Dysprosium153() } },

            { 0.0005099999999999999d, new List<RadioactiveSubstance> { new AlphaParticle(), new Terbium149() } },
