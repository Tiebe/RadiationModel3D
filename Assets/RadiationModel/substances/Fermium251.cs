...
namespace RadiationModel.substances
{
    public class Fermium251 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.982d, new List<RadioactiveSubstance> { new BetaParticle(), new Einsteinium251() } },

            { 0.018000000000000002d, new List<RadioactiveSubstance> { new AlphaParticle(), new Californium247() } },
