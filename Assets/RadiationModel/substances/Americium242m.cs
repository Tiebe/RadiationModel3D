...
namespace RadiationModel.substances
{
    public class Americium242m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9954999999999999d, new List<RadioactiveSubstance> { new GammaParticle(), new Americium242() } },

            { 0.0045000000000000005d, new List<RadioactiveSubstance> { new AlphaParticle(), new Neptunium238() } },
