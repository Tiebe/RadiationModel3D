...
namespace RadiationModel.substances
{
    public class Yttrium80m : RadioactiveSubstance
    {
        ...
        {
            { 0.81d, new List<RadioactiveSubstance> { new GammaParticle(0.00544, 228000.0), new Yttrium80() } },
            { 0.19d, new List<RadioactiveSubstance> { new BetaParticle(1, 9391000.0), new Strontium80() } },
