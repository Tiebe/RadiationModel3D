...
namespace RadiationModel.substances
{
    public class Terbium151 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9999049999999999d, new List<RadioactiveSubstance> { new BetaParticle(), new Gadolinium151() } },

            { 9.499999999999999e-05d, new List<RadioactiveSubstance> { new AlphaParticle(), new Europium147() } },
