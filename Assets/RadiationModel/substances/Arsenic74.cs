...
namespace RadiationModel.substances
{
    public class Arsenic74 : RadioactiveSubstance
    {
        ...
        {
            { 0.66d, new List<RadioactiveSubstance> { new BetaParticle(1, 2562351.0), new Germanium74() } },
            { 0.34d, new List<RadioactiveSubstance> { new BetaParticle(-1, 1353110.0), new Selenium74() } },
