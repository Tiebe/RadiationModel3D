...
namespace RadiationModel.substances
{
    public class Plutonium235 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.9999720000000001d, new List<RadioactiveSubstance> { new BetaParticle(), new Neptunium235() } },

            { 2.8e-05d, new List<RadioactiveSubstance> { new AlphaParticle(), new Uranium231() } },
