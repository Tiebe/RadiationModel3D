...
namespace RadiationModel.substances
{
    public class Tungsten164 : RadioactiveSubstance
    {
        ...
        {
            { 0.9620000000000001d, new List<RadioactiveSubstance> { new BetaParticle(1, 5047000.0), new Tantalum164() } },
            { 0.038d, new List<RadioactiveSubstance> { new AlphaParticle(6300002.09), new Hafnium160() } },
