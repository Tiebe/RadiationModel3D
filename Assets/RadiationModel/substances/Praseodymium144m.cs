...
namespace RadiationModel.substances
{
    public class Praseodymium144m : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, Dictionary<double, RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 0.0007000000000000001d, new Dictionary<double, RadioactiveSubstance> { { 1.0d, new Neodymium144() }, { 1.0d, new BetaParticle(-1, betaMinusSpectrum) }, { 0.00017d, new GammaParticle(617800.0, 0.00201) }, { 0.00033d, new GammaParticle(1631360.0, 0.00076) }, { 0.00010999999999999999d, new GammaParticle(1885300.0, 0.00066) } } },
