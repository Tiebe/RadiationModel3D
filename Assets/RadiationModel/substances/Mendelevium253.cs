...
namespace RadiationModel.substances
{
    public class Mendelevium253 : RadioactiveSubstance
    {
        ...
        public override Dictionary<double, List<RadioactiveSubstance>> decayProducts { get; } = new()
        {
            ...
            { 1.0d, new List<RadioactiveSubstance> { new BetaParticle(), new Fermium253() } },

            { 0.006999999999999999d, new List<RadioactiveSubstance> { new AlphaParticle(), new Einsteinium249() } },
