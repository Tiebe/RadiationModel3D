...
namespace RadiationModel.substances
{
    public class Indium118n : RadioactiveSubstance
    {
        ...
        {
            { 0.0d, new List<RadioactiveSubstance> { new GammaParticle((238000.0, 0.00521)), new Indium118() } },
            { 0.972196d, new List<RadioactiveSubstance> { new GammaParticle((140000.0, 0.00886)), new Indium118m() } },
